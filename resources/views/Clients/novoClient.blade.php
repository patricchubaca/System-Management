...
<section  class="section">
  ...
  <div class="container ">
    ...
    <div class="col-md-7 col-lg-12 mt-1 border">
     ...
     <form class="needs-validation  px-5 py-1 mt-1" method="POST" action="{{ route('storeClient')}}">
      @csrf
    <div class="alert border" role="alert">
      ...
      <div class="row g-3 mt-4">
        ...
        <div class="col-sm-4">
          ...
          <input type="text" class="form-control" id="lastName" placeholder="Água verde" name="bairro" value="" required>
          <div class="invalid-feedback">
            Valid last name is required.
          </div>
        </div>
        ...
        <div class="col-md-4">
          ...
          <input type="text" class="form-control" id="lastName" placeholder="Curitiba" value="" name="cidade" required>
          <div class="invalid-feedback">
            Valid last name is required.
          </div>
          <div class="invalid-feedback">
