                ...
                <div class="row g-3 mt-3">
                    ...
                    <div class="row g-3 mt-3">
                        ...
                        <div class="col-md-5">
                            ...
                            <input type="text" class="form-control" id="lastName" placeholder="Informações adicionais ?"
                        ...
                        <div class="row gy-3 mt-1">
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" id="cc-name"
                                    placeholder="Fernanda Cabral Bragança" name="contato2" required>
                                <div class="invalid-feedback">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" id="cc-cvv"
                                    placeholder="ferbragança@outlook.com" name="email2" required>
                                <div class="invalid-feedback">
                                    Security code required
                                </div>
                            </div>
