            ...
            <form class="needs-validation  px-5 py-1 mt-1" method="POST" action="{{ route('storeCotacao') }}">
                ...
                <div class="row g-3 mt-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control" id="lastName" placeholder="Tipo" value=""
                            name="cor" required>
                        <div class="invalid-feedback">
                    ...
                    <div class="col-md-3">
                        <label for="zip" class="form-label">UASG Cliente</label>
                    ...
                    <div class="col-md-2">
                        ...
                        <input type="time" class="form-control" id="lastName" placeholder="Multas vinculadas ao Veiculo"
                ...
                <div class="row mt-3">
                    <button type="button" class="btn btn-danger mb-1">Avançar <i class="fa-solid fa-arrow-right-long"></i></button>
                </div>
