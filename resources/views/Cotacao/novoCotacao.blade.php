        ...
        <div class="col-md-7 col-lg-12 mt-1 border">
            ...
            <form class="needs-validation  px-5 py-1 mt-1" method="POST" action="{{ route('storeCotacao') }}">
                ...
                <div class="row g-3 mt-3">
                    ...
                    <div class="col-sm-6">
                        <label for="lastName" class="form-label">Portal</label>
                ...
                <div class="row g-3 mt-5">
                    ...
                    <div class="col-md-5">
                        ...
                        <input type="text" class="form-control" id="lastName" placeholder="30 X 1220,00" name="quitacao"
                            value="" required>
                        <div class="invalid-feedback">
                            Valid last name is required.
                        </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control" id="lastName" placeholder="Multas vinculadas ao Veiculo"
                            value="" name="multa" required>
                        <div class="invalid-feedback">
                            Valid last name is required.
                        </div>
                        <div class="invalid-feedback">
                ...
                <div class="row gy-3 mt-1">
                    <div class="col-md-8">
                        ...
                        <input type="text" class="form-control" id="cc-name" placeholder="" name="nomeVendedor"
                            required>
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="date" class="form-control" id="cc-cvv" placeholder="" name="dataEntrada"
                            required>
                        <div class="invalid-feedback">
                    ...
                    <hr class="col-12">
                    <button class="w-100 btn btn-primary btn-lg" type="submit">Avançar Cotação</button>
                </div>
        </div>
        </form>
        </div>
